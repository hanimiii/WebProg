				...
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
                      ...
                      <table class="table table-hover">
                        ...
                        //   $sql = "SELECT c.*, s.* FROM subjecttook stk
                        //           INNER JOIN student st on stk.studentID = st.studentID LEFT JOIN class c on c.classID = stk.classID
                        //           RIGHT JOIN subject s on s.subjectID = stk.subjectID ";
                        ...
                        <tr>
                          ...
                          <td><?=$row['StudentPic'];?></td>
                          <td><?=$row['StudentRegistered'];?></td>
                          <td></td>
                          <td></td>
                          <td></td>
