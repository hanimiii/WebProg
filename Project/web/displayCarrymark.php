...
<?php
    ...
    //Class sql
    $sql2 = "SELECT class.ClassID, student.*, carrymark.* FROM subjecttook
                ...
                WHERE subjecttook.staffID = '$id' and class.ClassID = '$clsID' ";
						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li><a href="displayClass.php">View Class</a><span>«</span></li>
                  <li>View Student</li>
								</ul>
							</div>
						</div>
					...
					<div class="inner_content_w3_agile_info two_in" >
                      ...
                      <table class="table table-hover">
                        ...
                        <tr>
                          ...
                          <td><?=$row2['markLab'];?>%</td>
                          <td><?=$row2['markQ_A'];?>%</td>
                          <td><?=$row2['markTest1'];?>%</td>
                          <td><?=$row2['markTest2'];?>%</td>
                          <td><?=$row2['markProposal'];?>%</td>
                          <td><?=$row2['markPresentation'];?>%</td>
                          <td><?=$row2['markReport'];?>%</td>
                          <?php
                            $total =  $row2['markLab'] + $row2['markQ_A'] + $row2['markTest1'] + $row2['markTest2']
                                      + $row2['markProposal'] + $row2['markPresentation'] + $row2['markReport']; 
                          ?>
                          <td><?=$total;?>%</td>
                        </tr>
                        <?php endwhile;?>
                    </table>
                    <button class="btn btn-hover btn-dark btn-block" onclick="myFunction()">Print this page</button>
                  </div>
								</div>
						</div>
					<div class="clearfix"></div>
