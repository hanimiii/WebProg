...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="<?=(($id == "1")?'adminIndex.php':'main-page.php')?>"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Peninsula Carry Mark System </a></h1></li>
				       ...
				       <ul class="top_dp_agile">
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="profile.php"><i class="fa fa-user"></i> Settings</a> </li>
